...
public class AdminMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        createNurseButton = new javax.swing.JButton();
        ...
        findButton.setBounds(50, 250, 170, 40);
        ...
        changeButton.setBounds(50, 310, 170, 40);
        ...
        cancelButton.setBounds(50, 370, 170, 40);

        createNurseButton.setFont(new java.awt.Font("Comic Sans MS", 0, 12)); // NOI18N
        createNurseButton.setText("Create Nurse");
        createNurseButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                createNurseButtonActionPerformed(evt);
            }
        });
        panel.add(createNurseButton);
        createNurseButton.setBounds(50, 190, 170, 40);
    ...
    private void createAdminButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createAdminButtonActionPerformed
        CreateUser createAdmin = new CreateUser(ADMIN, ADMIN);
    ...
    private void createDoctorButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createDoctorButtonActionPerformed
        CreateUser createDoctor = new CreateUser(ADMIN, DOCTOR);
    ...
    private void createNurseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createNurseButtonActionPerformed
        CreateUser createAdmin = new CreateUser(ADMIN, NURSE);
	createAdmin.CreateUserVisible();
	this.dispose();
    }//GEN-LAST:event_createNurseButtonActionPerformed
    ...
    private javax.swing.JButton createNurseButton;
