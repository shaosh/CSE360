...
public class ChangePassword extends javax.swing.JFrame {
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        if(String.valueOf(oldField.getPassword()).equals(String.valueOf(newField.getPassword()))){
            JOptionPane.showMessageDialog(null, "The new password should be different from the old one!", "ERROR", JOptionPane.INFORMATION_MESSAGE);		
        }
        else if (String.valueOf(confirmField.getPassword()).equals(String.valueOf(newField.getPassword())) == false){
            JOptionPane.showMessageDialog(null, "Please re-confirm your new password!", "ERROR", JOptionPane.INFORMATION_MESSAGE);		
        }
        else{
            //Go to doctorMain just to make the whole GUI work
