...
public class PatientSignIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Patient SignIn");
        setName("frame"); // NOI18N
        setPreferredSize(new java.awt.Dimension(450, 300));
        setResizable(false);
        getContentPane().setLayout(null);

        patientSignin.setMaximumSize(new java.awt.Dimension(450, 300));
        patientSignin.setMinimumSize(new java.awt.Dimension(0, 0));
        ...
        getContentPane().add(patientSignin);
        patientSignin.setBounds(0, 0, 450, 300);
