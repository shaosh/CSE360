...
//        dayCombo.setMaximumRowCount(10);
	...
	radioGroup.add(femaleRadio);
        if(this.type == MERGE){
            mergeReminderLabel.setText("Find the second user to merge");
        }
    }
    ...
    private void initComponents() {
        ...
        mergeReminderLabel = new javax.swing.JLabel();
        ...
        mergeReminderLabel.setFont(new java.awt.Font("Comic Sans MS", 0, 10)); // NOI18N
        panel.add(mergeReminderLabel);
        mergeReminderLabel.setBounds(70, 10, 310, 20);
...
//	this.setVisible(false);        // TODO add your handling code here:
    ...
    //*******************************	
        ...
        //Use dialog to show if search is success
            ...
            ConfirmMerge confirmMerge = new ConfirmMerge();
            confirmMerge.ConfirmMergeVisible();
            this.dispose();
        }
        else{
    ...
    private javax.swing.JLabel mergeReminderLabel;
